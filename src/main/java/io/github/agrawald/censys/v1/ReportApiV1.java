...
public class ReportApiV1 extends GenericApi {
    private static final String URI_PATTERN = "/report/%s";

    public ReportApiV1(String rootUri, String username, String password, Proxy proxy) {
        super(rootUri, username, password, proxy);
    }

    public JsonNode search(Type type, ReportOpRequest request) throws IOException, InterruptedException, CensysException {
